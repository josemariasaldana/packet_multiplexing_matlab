...
% Si se quiere usar una duracion para conseguir 12000 paquetes (Montecarlo para el 1%) de un tamaño deseado y unos kbps deseados
%son los bps que tendrá el tráfico deseado
%duracion_prueba = 12000 * 8 * tamano_fijo / (kbps_tamano_fijo * 1000)
% Si se quiere usar una duracion para conseguir 25000 paquetes (Montecarlo para el 0.5%) de un tamaño deseado y unos kbps deseados
%son los bps que tendrá el tráfico deseado
duracion_prueba = 25000 * 8 * tamano_fijo / (kbps_tamano_fijo * 1000)
...
for kbits_por_segundo_buffer = 10000:1000:10000;
bits_por_segundo_buffer = 1000 * kbits_por_segundo_buffer;

%si es muy grande, no limita
%for paq_por_segundo_buffer = 2000:500:3500; 
...
for retardo_procesado = 0:20:0; %en microseg. Tiempo entre paquetes que salen seguidos. El buffer no es capaz de concatenarlos perfectamente
