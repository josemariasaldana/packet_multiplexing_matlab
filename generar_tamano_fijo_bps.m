...
for tamano = 50:100:1450

%%%%%%%%%% Ancho de banda a generar %%%%%%%%%%
for bps = 100000:25000:100000;
...
nombre_background=strcat('.\_fixed_size\fixed_size_',num2str(tamano),'_bytes_',num2str(kbps_background),'_kbps_',num2str(duracion),'_seg.txt');
