This Matlab code is for simulating the multiplexing (aggregation) of packets. You can aggregate VoIP packets, and also packets of different First Person Shooter video games. You can add background traffic.
